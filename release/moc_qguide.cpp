...
struct qt_meta_stringdata_QGuide_t {
    QByteArrayData data[1];
    char stringdata[7];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QGuide_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QGuide_t qt_meta_stringdata_QGuide = {
    {
QT_MOC_LITERAL(0, 0, 6) // "QGuide"
...
void QGuide::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject QGuide::staticMetaObject = {
    { &QGameElement::staticMetaObject, qt_meta_stringdata_QGuide.data,
      qt_meta_data_QGuide,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QGuide::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGuide.stringdata))
